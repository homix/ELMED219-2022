...
- **LaTeX template for the report**  is found [[here](./latex-template/ELMED219_2022_project_team_k.tex)] with a dummy figure [[here](./latex-template/elmed219_dummy_fig.png)], resulting in the following dummy report [[pdf](./latex-template/ELMED219_2022_project_team_k.pdf)].
